...
export class UpdateModalComponent implements OnInit {
  ...
  constructor(private _electronService: ElectronService, public activeModal: NgbActiveModal, private ref: ChangeDetectorRef) {
  ...
  downloadProgress(event, data) {
    ...
    component.speed = (data.data.bytesPerSecond / 100000).toFixed(2);
